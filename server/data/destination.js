const destinations = [
  {
    ...
    description:
      "Mountain escapes, peaceful valleys, and unforgettable adventures.",
...

  {
    ...
    description:
      "Relaxed beaches, vibrant culture, and coastal experiences.",
    safetyLevel: "Good to go",
    safetyColor: "green",
...

  {
    ...
    description:
      "Royal architecture, colorful markets, and rich history.",
...

  {
    ...
    description:
      "Riverside adventures, yoga, and a refreshing escape.",
    safetyLevel: "Good to go",
    safetyColor: "green",
